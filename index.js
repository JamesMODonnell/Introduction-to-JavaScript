...
function hungryDog(weight,years){
    if (years >= 1 && weight > 15) {
      return .02 * weight 
    }
    if (years>= 1 &&  weight <= 15 && weight >= 11) {
      return .03 * weight 
    }
    if (years>= 1 && weight < 11 && weight >=6 || years >= .59 && years <= .99) {
      return .04 * weight 
    }
    if (years>= 1 && weight < 6 || years >= .33 && years<=.58) {
      return .05 * weight
    }
    if (years>=.16 && years>=.32){
      return .10 * weight 
    }
  }
